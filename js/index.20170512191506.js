...
r=function(){dpi=window.devicePixelRatio;$('.js-2').attr('src', (dpi>1) ? 'images/drippn-300.jpg' : 'images/drippn-150.jpg');
...
$('.js-9').attr('src', (dpi>1) ? 'images/screen-shot-2017-03-31-at-11.49.29-pm-1014.jpg' : 'images/screen-shot-2017-03-31-at-11.49.29-pm-507.jpg');
$('.js-11').attr('src', (dpi>1) ? 'images/dd-432.png' : 'images/dd-216.png');
$('.js-13').attr('src', (dpi>1) ? 'images/com.hammerandchisel.discord-large-422.png' : 'images/com.hammerandchisel.discord-large-211.png');

$('.js-17').attr('src', (dpi>1) ? 'images/com.atebits.tweetie2-large-176.png' : 'images/com.atebits.tweetie2-large-88.png');
$('.js-18').attr('src', (dpi>1) ? 'images/com.google.inbox-large-202.png' : 'images/com.google.inbox-large-101.png');
$('.js-19').attr('src', (dpi>1) ? 'images/com.reddit.reddit-large-186.png' : 'images/com.reddit.reddit-large-93.png');};
